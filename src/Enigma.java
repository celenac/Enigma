 ...
 *
 * How to use:
 * *** The first line of the input file must contain the initial settings for the Enigma machine.
 * *** Format: * (rotor 1) (rotor 2) (rotor 3) (rotor 4) (rotor 5) (initial_letters)
 * *** Example: * B BETA III IV I AXLE
 *
 * To code a message:
 * *** Write the initial Enigma rotor settings as the first line of a file. Then insert the original message into the file. Use this file as the "input file."
 * *** Creating an Enigma object with this input file's path as the "input" argument and a separate file path as the "output" argument will code the message into the "output" file.
 *
 * To decode the message:
 * *** Write the same initial Enigma rotor settings used to code the original message on the first line of a file. Then insert the coded original message into the file. Use this file as the "input file."
 * *** Creating an Enigma object with this input file's path as as the "input" argument and a separate file path as the "output" argument will decode the message into the "output" file.
 */
...
public class Enigma {
    ...
    public static void main (String[] args) throws IOException {
        //Example
        String input = "C:\\Users\\Celena\\Documents\\GitHub\\Enigma\\src\\inputFile.txt";
        String output = "C:\\Users\\Celena\\Documents\\GitHub\\Enigma\\src\\outputFile.txt";
     ...
     * The first line of the input message must be in the format: * (rotor 1) (rotor 2) (rotor 3) (rotor 4) (rotor 5) (initial_letters)
     * Example: * B BETA III IV I AXLE
    ...
    /**
     * Creates all settings for the M4 Enimga Machine
     */
    ...
    /**
     * Analyzes the first line of the input file to set the initial settings for the Enigma machine. Inputs the decoded message to OUTPUTfILE.
    ...
    public void setDecodingSetting(String line){
        ...
        initialSettingsArrayList.removeAll(Arrays.asList("", null)); //citation: answer from "smas" on https://stackoverflow.com/questions/5520693/in-java-remove-empty-elements-from-a-list-of-strings
    ...
    public Object getReversedRotorValue(HashMap hm, Object value){ //Citation: Rupesh Yadav's answer on https://stackoverflow.com/questions/8112975/get-key-from-a-hashmap-using-the-value
        Object result = null;
